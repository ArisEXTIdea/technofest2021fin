            ...
            <div className='container-fluid'>
                ...
                <div className="row ml-client-form-row">
                    ...
                    <div className="col-12 col-md-6 p-5 alig-itmes-center">
                        ...
                        <p className='text-justify'>Silahkan bergabung dengan group whatsapp kompetisi band di link berikut dan jangan lupa melakukan konfirmasi pembayaran ke nomor <b>082137085668 (Hilmi)</b> </p>
                        <a href="https://chat.whatsapp.com/Fl7gQq77NXU6LTHt5Ovk6S "><Button title="Gabung Group Whatsapp" addStyle="btn-block"/></a>
